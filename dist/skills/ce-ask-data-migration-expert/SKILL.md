...
`references/agent-prompts/ce-data-migration-expert.md`.

## Steps

1. Read `references/agent-prompts/ce-data-migration-expert.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-data-migration-expert.md` is missing (upstream rename, partial install),
report:
