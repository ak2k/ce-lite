...
`references/agent-prompts/ce-api-contract-reviewer.md`.

## Steps

1. Read `references/agent-prompts/ce-api-contract-reviewer.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-api-contract-reviewer.md` is missing (upstream rename, partial install),
report:
