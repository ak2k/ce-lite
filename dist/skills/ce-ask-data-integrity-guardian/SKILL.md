...
1. Run `ce-lite-persona ce-data-integrity-guardian --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-data-integrity-guardian via=ce-ask-direct]`
