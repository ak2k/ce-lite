...
`references/agent-prompts/ce-data-integrity-guardian.md`.

## Steps

1. Read `references/agent-prompts/ce-data-integrity-guardian.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-data-integrity-guardian.md` is missing (upstream rename, partial install),
report:
