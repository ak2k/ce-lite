...
1. Run `ce-lite-persona ce-framework-docs-researcher --body` via Bash. The resolver is on
...
2. Spawn an `Agent` with `subagent_type: "general-purpose"` and
   ...
   You are operating as the ce-framework-docs-researcher specialist. Manifest declares
