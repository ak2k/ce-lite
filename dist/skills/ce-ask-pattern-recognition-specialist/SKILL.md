...
`references/agent-prompts/ce-pattern-recognition-specialist.md`.

## Steps

1. Read `references/agent-prompts/ce-pattern-recognition-specialist.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-pattern-recognition-specialist.md` is missing (upstream rename, partial install),
report:
