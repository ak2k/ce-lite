...
`references/agent-prompts/ce-testing-reviewer.md`.

## Steps

1. Read `references/agent-prompts/ce-testing-reviewer.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-testing-reviewer.md` is missing (upstream rename, partial install),
report:
