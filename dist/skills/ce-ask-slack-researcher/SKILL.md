...
`references/agent-prompts/ce-slack-researcher.md`.

## Steps

1. Read `references/agent-prompts/ce-slack-researcher.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-slack-researcher.md` is missing (upstream rename, partial install),
report:
