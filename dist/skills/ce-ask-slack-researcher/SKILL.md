...
1. Run `ce-lite-persona ce-slack-researcher --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-slack-researcher via=ce-ask-direct]`
