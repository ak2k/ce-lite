...
1. Run `ce-lite-persona ce-adversarial-document-reviewer --body` via Bash. The resolver is on
...
2. Spawn an `Agent` with `subagent_type: "general-purpose"` and
   ...
   You are operating as the ce-adversarial-document-reviewer specialist. Manifest declares
