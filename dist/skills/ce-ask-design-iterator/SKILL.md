...
`references/agent-prompts/ce-design-iterator.md`.

## Steps

1. Read `references/agent-prompts/ce-design-iterator.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-design-iterator.md` is missing (upstream rename, partial install),
report:
