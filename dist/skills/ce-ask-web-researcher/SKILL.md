...
1. Run `ce-lite-persona ce-web-researcher --body` via Bash. The resolver is on
...
2. Spawn an `Agent` with `subagent_type: "general-purpose"` and
   ...
   You are operating as the ce-web-researcher specialist. Manifest declares
   this role uses tools=[WebSearch, WebFetch] and model=sonnet. Honour
