...
`references/agent-prompts/ce-repo-research-analyst.md`.

## Steps

1. Read `references/agent-prompts/ce-repo-research-analyst.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-repo-research-analyst.md` is missing (upstream rename, partial install),
report:
