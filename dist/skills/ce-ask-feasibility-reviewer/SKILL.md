...
1. Run `ce-lite-persona ce-feasibility-reviewer --body` via Bash. The resolver is on
...
2. Spawn an `Agent` with `subagent_type: "general-purpose"` and
   ...
   You are operating as the ce-feasibility-reviewer specialist. Manifest declares
