...
1. Run `ce-lite-persona ce-design-lens-reviewer --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-design-lens-reviewer via=ce-ask-direct]`
