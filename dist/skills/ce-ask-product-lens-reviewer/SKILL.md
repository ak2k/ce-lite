...
`references/agent-prompts/ce-product-lens-reviewer.md`.

## Steps

1. Read `references/agent-prompts/ce-product-lens-reviewer.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-product-lens-reviewer.md` is missing (upstream rename, partial install),
report:
