...
`references/agent-prompts/ce-code-simplicity-reviewer.md`.

## Steps

1. Read `references/agent-prompts/ce-code-simplicity-reviewer.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-code-simplicity-reviewer.md` is missing (upstream rename, partial install),
report:
