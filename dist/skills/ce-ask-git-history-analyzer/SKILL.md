...
`references/agent-prompts/ce-git-history-analyzer.md`.

## Steps

1. Read `references/agent-prompts/ce-git-history-analyzer.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-git-history-analyzer.md` is missing (upstream rename, partial install),
report:
