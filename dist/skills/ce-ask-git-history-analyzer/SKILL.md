...
1. Run `ce-lite-persona ce-git-history-analyzer --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-git-history-analyzer via=ce-ask-direct]`
