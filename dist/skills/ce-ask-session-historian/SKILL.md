...
`references/agent-prompts/ce-session-historian.md`.

## Steps

1. Read `references/agent-prompts/ce-session-historian.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-session-historian.md` is missing (upstream rename, partial install),
report:
