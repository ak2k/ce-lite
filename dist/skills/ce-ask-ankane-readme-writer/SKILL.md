...
`references/agent-prompts/ce-ankane-readme-writer.md`.

## Steps

1. Read `references/agent-prompts/ce-ankane-readme-writer.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-ankane-readme-writer.md` is missing (upstream rename, partial install),
report:
