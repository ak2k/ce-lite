...
1. Run `ce-lite-persona ce-ankane-readme-writer --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-ankane-readme-writer via=ce-ask-direct]`
