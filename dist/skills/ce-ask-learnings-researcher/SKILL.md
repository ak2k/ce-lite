...
1. Run `ce-lite-persona ce-learnings-researcher --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-learnings-researcher via=ce-ask-direct]`
