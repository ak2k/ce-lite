...
`references/agent-prompts/ce-architecture-strategist.md`.

## Steps

1. Read `references/agent-prompts/ce-architecture-strategist.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-architecture-strategist.md` is missing (upstream rename, partial install),
report:
