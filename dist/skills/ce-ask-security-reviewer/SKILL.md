...
1. Run `ce-lite-persona ce-security-reviewer --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-security-reviewer via=ce-ask-direct]`
