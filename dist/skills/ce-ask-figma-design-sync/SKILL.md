...
`references/agent-prompts/ce-figma-design-sync.md`.

## Steps

1. Read `references/agent-prompts/ce-figma-design-sync.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-figma-design-sync.md` is missing (upstream rename, partial install),
report:
