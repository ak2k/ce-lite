...
1. Run `ce-lite-persona ce-performance-oracle --body` via Bash. The resolver is on
...
2. Spawn an `Agent` with `subagent_type: "general-purpose"` and
   ...
   You are operating as the ce-performance-oracle specialist. Manifest declares
