...
`references/agent-prompts/ce-performance-oracle.md`.

## Steps

1. Read `references/agent-prompts/ce-performance-oracle.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-performance-oracle.md` is missing (upstream rename, partial install),
report:
