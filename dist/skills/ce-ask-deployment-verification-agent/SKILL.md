...
1. Run `ce-lite-persona ce-deployment-verification-agent --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-deployment-verification-agent via=ce-ask-direct]`
