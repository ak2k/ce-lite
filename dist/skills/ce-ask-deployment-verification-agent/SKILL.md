...
`references/agent-prompts/ce-deployment-verification-agent.md`.

## Steps

1. Read `references/agent-prompts/ce-deployment-verification-agent.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-deployment-verification-agent.md` is missing (upstream rename, partial install),
report:
