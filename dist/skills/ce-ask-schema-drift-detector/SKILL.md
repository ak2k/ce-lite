...
`references/agent-prompts/ce-schema-drift-detector.md`.

## Steps

1. Read `references/agent-prompts/ce-schema-drift-detector.md` for the persona's full role definition.
...
If `references/agent-prompts/ce-schema-drift-detector.md` is missing (upstream rename, partial install),
report:
