...
1. Run `ce-lite-persona ce-security-lens-reviewer --prefix` via Bash. Output is the
   full prompt prefix — persona body, `[ce-persona=ce-security-lens-reviewer via=ce-ask-direct]`
